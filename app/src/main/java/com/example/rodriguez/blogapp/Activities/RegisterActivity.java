        ...
        mAuth.createUserWithEmailAndPassword(email,password)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Log.i("RegisterActivity", "CreateUserAccount: " + Objects.requireNonNull(task.getException()).getMessage());
                        Log.i("RegisterActivity", "CreateUserAccount: " + Objects.requireNonNull(task.getException()).getCause());
                        Log.i("RegisterActivity", "CreateUserAccount: " + Arrays.toString(Objects.requireNonNull(task.getException()).getStackTrace()));
